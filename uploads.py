...
class UploadMethods:
    ...
    async def send_file(
            ...
            *,
            ...
            attributes: typing.Union['typing.Sequence[types.TypeDocumentAttribute]', typing.List[
                'typing.Sequence[types.TypeDocumentAttribute]']] = None,
            thumb: typing.Union['hints.FileLike', typing.List['hints.FileLike']] = None,
    ...
    async def _send_album(self: 'TelegramClient', entity, files, caption='',
        ...
        for sent_count, file in enumerate(files):
            ...
            fh, fm, _ = await self._file_to_media(
                ...
                attributes=attributes[count] if attributes else None,
                thumb=thumb[count] if thumb else None,
